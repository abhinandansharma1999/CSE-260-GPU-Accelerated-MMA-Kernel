...
include ./build_T4/arch.cuda.gnu
...
OBJECTS = build_T4/mmpy.o  build_T4/mmpy_host.o  build_T4/genMatrix.o build_T4/cmdLine.o build_T4/Timer.o build_T4/utils.o build_T4/Report.o build_T4/setGrid.o

all:
	$(NVCC) $(NVCCFLAGS) -c src/mmpy.cu -o build_T4/mmpy.o
	$(C++) $(C++FLAGS) -c src/mmpy_host.cpp -o build_T4/mmpy_host.o
	$(C++) $(C++FLAGS) -c src/genMatrix.cpp -o build_T4/genMatrix.o
	$(C++) $(C++FLAGS) -c src/cmdLine.cpp -o build_T4/cmdLine.o
	$(C++) $(C++FLAGS) -c src/Timer.cpp -o build_T4/Timer.o
	$(NVCC) $(NVCCFLAGS) -c src/utils.cu -o build_T4/utils.o
	$(C++) $(C++FLAGS) -c src/Report.cpp -o build_T4/Report.o
	$(NVCC) $(NVCCFLAGS) -c src_todo_T4/setGrid.cu -o build_T4/setGrid.o
	$(NVCC) -o $(APP) $(LDFLAGS) $(OBJECTS)  $(LDLIBS) -lcublas

clean:
	rm -rf build_T4/*.o src_todo_T4/*.o $(APP)
